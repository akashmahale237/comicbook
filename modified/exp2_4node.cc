...
main (int argc, char *argv[])
{
  ...
  p2p3.SetDeviceAttribute ("DataRate", StringValue ("15Mbps"));
  ...
  devices3 = p2p3.Install (nodes.Get(3),nodes.Get(1));
...
uint16_t sinkPort3 = 8070;
  ...
  app->Setup (ns3TcpSocket, sinkAddress, 2048, 100, DataRate ("1Mbps"));
  ...
  app1->Setup (ns3TcpSocket1, sinkAddress1, 2048, 100, DataRate ("1Mbps"));
  ...
  app3->Setup (ns3TcpSocket3, sinkAddress3, 2048, 100, DataRate ("1Mbps"));
 ...
 AsciiTraceHelper asciiTraceHelper;
  ...
  Ptr<OutputStreamWrapper> stream3 = asciiTraceHelper.CreateFileStream ("exp2_3.cwnd");
  ns3TcpSocket3->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream3));


  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("exp2_pcap.pcap", std::ios::out, PcapHelper::DLT_PPP);
...
//for data file
  ...
  plotHelper.ConfigurePlot ("exp2_gnu",
 ...
 p2p1.EnablePcapAll("exp2_2_1");
  p2p2.EnablePcapAll("exp2_2_2");
  
AnimationInterface anim ("exp2_exp2.xml");
anim.SetConstantPosition (nodes.Get (0), 200, 100);  
anim.SetConstantPosition (nodes.Get (1), 100, 200);   
anim.SetConstantPosition (nodes.Get (2), 200, 200);
 anim.SetConstantPosition (nodes.Get (3), 300, 300);
  

 //Gnuplot parameters
      
    std::string fileNameWithNoExtension = "TCP4node_Throuhput";
