...
//fading model ends
  ...
  ueNodes.Get (2)->GetObject<ConstantVelocityMobilityModel> ()->SetVelocity (Vector (-1*speed,0.1*speed,0));
  ueNodes.Get (3)->GetObject<MobilityModel> ()->SetPosition (Vector (900, 700, 700));
  ueNodes.Get (3)->GetObject<ConstantVelocityMobilityModel> ()->SetVelocity (Vector (-1*speed,0.2*speed,0));
  ueNodes.Get (4)->GetObject<MobilityModel> ()->SetPosition (Vector (1100, 800, 800));
  ueNodes.Get (4)->GetObject<ConstantVelocityMobilityModel> ()->SetVelocity (Vector (-1*speed,0.3*speed,0));
  ueNodes.Get (5)->GetObject<MobilityModel> ()->SetPosition (Vector (1300, 900, 900));
  ueNodes.Get (5)->GetObject<ConstantVelocityMobilityModel> ()->SetVelocity (Vector (-1*speed,0.4*speed,0));
